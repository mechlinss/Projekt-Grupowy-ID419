...
def find_crystals(photo_path: str, thresh=40, min_area=50, kernel_size=3, open_iter=2, close_iter=2):
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print(json.dumps({"ERROR": "Usage: morphology.py <input_path> <output_path> [thresh] [min_area] [kernel_size] [open_iter] [close_iter]"}))
        sys.exit(1)
